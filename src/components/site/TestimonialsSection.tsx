...
const testimonials = [
  {
    quote: "Alex shipped a brand and product experience that genuinely moved the needle. Our trial-to-paid conversion jumped 34%.",
    name: "Jordan Reeves",
    title: "Founder, Helio",
    avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&q=80",
  },
  {
    quote: "The kind of partner you wish every project had — fast, opinionated, and obsessed with the details that matter.",
    name: "Priya Shah",
    title: "Head of Design, Lumen Labs",
    avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80",
  },
  {
    quote: "From discovery to launch in nine weeks. The site looks incredible and performs even better.",
    name: "Marco Bianchi",
    title: "VP Marketing, Northwind",
