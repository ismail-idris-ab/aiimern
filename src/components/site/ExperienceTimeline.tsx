const experience = [
  ...
  },
  {
    ...
    company: "Independent",
    period: "2015 — 2017",
    desc: "Worked with 20+ founders to launch their MVPs and first brand systems.",
  },
];
    ...
    <section className="section-pad bg-surface/40" id="experience">
      <div className="container-cf">
        ...
        <div className="mt-14 relative">
          <div className="absolute left-3 md:left-1/2 top-0 bottom-0 w-px bg-[var(--border)]" aria-hidden />
          <div className="space-y-10">
            {experience.map((e, i) => (
              <div key={e.role} className={`relative grid md:grid-cols-2 gap-6 md:gap-12 ${i % 2 === 1 ? "md:[direction:rtl]" : ""}`}>
                <div className={`pl-10 md:pl-0 ${i % 2 === 1 ? "md:text-left md:[direction:ltr]" : "md:text-right"}`}>
                  <div className="card-cf p-6 inline-block text-left">
                    <div className="text-xs uppercase tracking-widest gold-text mb-2">{e.period}</div>
